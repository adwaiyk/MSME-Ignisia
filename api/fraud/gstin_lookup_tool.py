...
CREDIT_SCORE_PATH="/media/aditya/3C4F8EAC3C229A1D/college/Hackthon/Ignisia2026/pipeline/api/pipelining/get_credit_score.py"
...
spec2 = importlib.util.spec_from_file_location("credit_api", CREDIT_SCORE_PATH)
credit_api = importlib.util.module_from_spec(spec2)
spec2.loader.exec_module(credit_api)
...
def verify_gstin(target_gstin):
    ...
    result2= credit_api.score_from_gstin(target_gstin)
    print(result)
    print(result2)
